          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-2/3">
              {filteredPosts.map((post) => (
                <div key={post.id} className="mb-12 md:mb-16">
                  ...
                  <div className="lg:hidden">
                          ...
                          <div className="relative z-10 text-center">
                            <div className="mb-4">
                              <div className="inline-block bg-white/20 backdrop-blur-sm rounded-full p-8">
                                <svg className="w-24 h-24 md:w-32 md:h-32 text-white" fill="currentColor" viewBox="0 0 24 24">
                                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z" />
                                </svg>
                              </div>
                            </div>
                            <span className="text-white text-xl md:text-2xl font-semibold block drop-shadow-lg">General health</span>
                          </div>
                          {/* Logo Overlay for placeholder */}
                          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                            <div className="flex items-center gap-3">
                              <div className="w-12 h-12 md:w-14 md:h-14 bg-white rounded-lg overflow-hidden flex-shrink-0">
                                <img
                    ...
                    <div className="px-4 md:px-6">
                      <h1 className="text-2xl md:text-3xl font-bold text-blue-600 mb-6 leading-tight">
                        {post.title}
                      </h1>
                                ...
                                <ul className="space-y-2">
                                  {post.table_of_contents.map((item: any, index: number) => (
                                    <li key={item.id || index} className="group">
                                      ...
                                      >
                                        <span className="text-gray-800 group-hover:text-blue-600 font-medium text-sm leading-normal">
                                          {item.title}
                                        </span>
                                      </a>
                                    </li>
                      ...
                      {/* Actions - Mobile/Tablet Centered */}
