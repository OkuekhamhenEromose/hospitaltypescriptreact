  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontSize: 16, fontWeight: 700, color: "#0d1b2e" }}>
            {title}
          </span>
          <button
            onClick={onClose}
          ...
          >
            <UniversalIcon name="X" size={14} style={{ color: "#8aa0ba" }} />
          </button>
        </div>
...
const PatientDashboard: React.FC = () => {
  ...
  const [tab, setTab] = useState<"all" | "book" | "reports" | "appointments">(
    "all",
  );
  ...
  const imgUrl = (
    ...
    return profilePix.startsWith("http")
      ? profilePix
      : `https://hospitalback-clean-0fre.onrender.com${profilePix}`;
  };

  const pName = (a: Appointment): string =>
    a.name || user?.profile?.fullname || "Patient";
  ...
  useEffect(() => {
    let f = appointments;
    if (tab === "reports") {
      f = f.filter((a) => a.medical_report);
    }

    if (tab !== "reports" && tab !== "appointments") {
      setFiltered([]);
      return;
    }
  ...
  return (
    patientName.toLowerCase().includes(lq) ||
    (a.message?.toLowerCase().includes(lq) ?? false) ||
    (a.medical_report?.medical_condition?.toLowerCase().includes(lq) ?? false)
  );
});
    }
    setFiltered(f);
  }, [appointments, tab, statusFilter, q, user?.profile?.fullname]);
  ...
  async function submitAppt(e: React.FormEvent): Promise<void> {
    e.preventDefault();
    try {
      ...
      alert("Failed to book appointment. Please check your data.");
    }
  }

  function downloadReport(a: Appointment): void {
    ...
    el.href = url;
    el.download = `report-${pName(a).replace(/ /g, "-")}-${new Date().toISOString().split("T")[0]}.txt`;
      ...
      >
        ...
        >
          ...
          {!collapsed && (
            <div>
              ...
              <div style={{ fontSize: 11, color: C.muted }}>Patient Portal</div>
            </div>
          )}
        </div>
        <nav
            ...
            return (
              ...
              >
                <UniversalIcon
                  name={n.icon}
                  size={17}
                  style={{ color: act ? C.blue2 : C.muted, flexShrink: 0 }}
                />
                {!collapsed && (
                  <>
                    <span
        ...
        <div style={{ borderTop: `1px solid ${C.soft}`, padding: "10px 8px" }}>
          ...
          >
            ...
            >
              {imgUrl(user?.profile as unknown as Record<string, unknown>) ? (
                <img
                  src={
                    imgUrl(user?.profile as unknown as Record<string, unknown>)!
                  }
            ...
            {!collapsed && (
              <div style={{ flex: 1, overflow: "hidden" }}>
                ...
                <div style={{ fontSize: 11, color: C.muted }}>Patient</div>
              </div>
            )}
          </div>
          <button
      ...
      >
        <header
          style={{
            ...
            top: 0,
            zIndex: 30,
            boxShadow: "0 1px 8px rgba(23,127,237,0.05)",
          }}
        >
          <div>
            ...
            >
              ...
              >
                {imgUrl(user?.profile as unknown as Record<string, unknown>) ? (
                  ...
                  >
                    {user?.profile?.fullname?.charAt(0) || "P"}
                  </span>
                )}
              </div>
            ...
            <div className="fi">
              <div
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "space-between",
                  boxShadow: `0 8px 32px ${C.blue1}44`,
                }}
              >
                <div>
                  <div
                  ...
                  <div style={{ fontSize: 13.5, opacity: 0.85 }}>
                    Track your health journey and manage appointments in one
                    place.
                  </div>
                </div>
                <button
                ...
                >
                  <UniversalIcon name="Plus" size={15} />
                  Book Appointment
                </button>
              </div>
              ...
              >
                {[
                  ...
                  },
                  {
                    ...
                    value: appointments.filter((a) => a.medical_report).length,
                    sub: "Available",
                    ctaBg: null,
                    cb: () => setTab("reports"),
                  },
                  {
                    ...
                    icon: "History",
                    grad: `135deg,#d97706,${C.amber}`,
                    value: appointments.length,
                    sub: "All visits",
                    ctaBg: null,
                    cb: () => setTab("appointments"),
                  },
                ].map((s, i) => (
                  <div
                    key={i}
                    ...
                    style={{
                      ...
                      boxShadow: "0 1px 4px rgba(23,127,237,0.05)",
                      transition: "all 0.2s",
                      cursor: "pointer",
                    }}
                    onClick={s.cb}
              ...
              >
                <div
                  style={{
                    ...
                    border: `1px solid ${C.soft}`,
                    overflow: "hidden",
                    boxShadow: "0 1px 6px rgba(23,127,237,0.05)",
                  }}
                >
                  <div
                    style={{
                  ...
                  {recent.length === 0 ? (
                    <div style={{ padding: "40px 20px", textAlign: "center" }}>
                      <UniversalIcon
                        name="Calendar"
                        size={32}
                        style={{ color: "#dce7f5", margin: "0 auto 8px" }}
                      />
                    ...
                    {[
                      {
                        ...
                        value: appointments.filter((a) => a.vitals).length,
                        bg: "#ecfdf5",
                        ic: "#059669",
                      },
                      {
                      ...
                      },
                      {
                        ...
                        value: appointments.filter(
                          (a) => a.medical_report?.drug_prescription,
                        ).length,
                        bg: "#faf5ff",
                        ic: C.purple,
                      },
          ...
          {tab === "book" && (
            ...
            >
              ...
              >
                ...
                >
                  <UniversalIcon name="Plus" size={22} />
                ...
                >
                  <UniversalIcon name="Alert" size={22} />
                  <div style={{ fontWeight: 700, fontSize: 14 }}>Emergency</div>
                  <div style={{ fontSize: 12, opacity: 0.85 }}>
                    Immediate attention
                  </div>
                </button>
            ...
            >
              <div
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "space-between",
                  background: `linear-gradient(135deg,${C.purple}08,${C.purple}14)`,
                }}
              >
                <div>
              ...
              {filtered.length === 0 ? (
                <div style={{ padding: "60px 24px", textAlign: "center" }}>
                  <UniversalIcon
                    name="FileText"
                    size={38}
                    style={{ color: "#dce7f5", margin: "0 auto 10px" }}
                  />
                  <div
                  ...
                  <div
                    style={{ fontSize: 12.5, color: "#b0bec5", marginTop: 4 }}
                  >
                    Reports appear here after completed appointments.
                  </div>
                </div>
              ) : (
                filtered.map((a, i) => (
                    ...
                    >
                          ...
                          >
                            <div
                              style={{
                                ...
                                gridTemplateColumns: "1fr 1fr",
                                gap: 12,
                                marginBottom: a.medical_report.advice ? 12 : 0,
                              }}
                            >
                              <div>
                                <div
                                ...
                                >
                                  {a.medical_report.medical_condition}
                                </div>
                              </div>
                              {a.medical_report.drug_prescription && (
                                <div>
                                  <div
                                    style={{
                                      fontSize: 11.5,
                      ...
                      <button
                        ...
                        style={{
                          ...
                          flexShrink: 0,
                          transition: "all 0.15s",
                          boxShadow: `0 2px 8px ${C.purple}44`,
                        }}
                      >
                        <UniversalIcon name="Download" size={13} />
                        Download
                      </button>
                    </div>
                  </div>
            ...
            >
              <div
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "space-between",
                  background: `linear-gradient(135deg,${C.amber}08,${C.amber}14)`,
                }}
              >
                <div>
                  <div style={{ fontSize: 15, fontWeight: 700, color: C.text }}>
                ...
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <option value="IN_REVIEW">In Review</option>
                      <option value="AWAITING_RESULTS">Awaiting</option>
                      <option value="COMPLETED">Completed</option>
                    </select>
                  </div>
                  <button
                  ...
                  >
                    <UniversalIcon name="Plus" size={13} />
                    New
                  </button>
                </div>
              </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: 11.5, color: "#b0bec5" }}>
                            Booked{" "}
                            {new Date(a.booked_at).toLocaleDateString("en-US", {
                              year: "numeric",
                              month: "short",
                              day: "numeric",
                              hour: "2-digit",
                          ...
                          {a.status !== "COMPLETED" && (
                            ...
                            >
                              ...
                              {a.status === "IN_REVIEW"
                                ...
                                : a.status === "AWAITING_RESULTS"
                                  ? "Waiting for lab/vital results."
                                  : "Your appointment is queued for assignment."}
                            </div>
                          )}
                        </div>
        ...
        <Modal title="Book New Appointment" onClose={() => setShowForm(false)}>
          <form onSubmit={submitAppt}>
            ...
            <input
              ...
              type="text"
              value={
                formData.name || user?.profile?.fullname || user?.username || ""
              }
              onChange={(e) =>
