  ...
  const handleSubmitVitals = async (e: React.FormEvent) => {
    ...
    try {
      await apiService.createVitals({
        ...
        ...vitalsData,
        respiration_rate: parseInt(vitalsData.respiration_rate) || null,
        pulse_rate: parseInt(vitalsData.pulse_rate) || null,
        body_temperature: parseFloat(vitalsData.body_temperature) || null,
        height_cm: parseFloat(vitalsData.height_cm) || null,
        weight_kg: parseFloat(vitalsData.weight_kg) || null
      });
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setVitalsData({ ...vitalsData, pulse_rate: e.target.value })}
                    placeholder="bpm"
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setVitalsData({ ...vitalsData, respiration_rate: e.target.value })}
                    placeholder="breaths/min"
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Body Temperature</label>
                  <input
                    type="number"
                    step="0.1"
                    value={vitalsData.body_temperature}
                    onChange={(e) => setVitalsData({ ...vitalsData, body_temperature: e.target.value })}
                    placeholder="°C"
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setVitalsData({ ...vitalsData, height_cm: e.target.value })}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setVitalsData({ ...vitalsData, weight_kg: e.target.value })}
                    className="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2"
                  />
                </div>
              </div>
